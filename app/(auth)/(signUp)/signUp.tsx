...
import { Button, Checkbox, HelperText, TextInput, Title } from "react-native-paper";
    ...
    const handleSignUp = async () => {
        ...
        if (Object.values(newErrors).some((error) => error !== "")) {
            ...
            try {
                let newUser;
                if (!isProfessional) {
                    newUser = await signUp(email, password, false);
                } else {
                    newUser = await signUp(email, password, true);
                }
                if (newUser) {
                    router.replace("/home");
                }
